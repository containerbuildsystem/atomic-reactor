...
def test_url_label(tmpdir, docker_tasker, caplog, url_format, info_url, reactor_config_map):
    if MOCK:
        mock_docker()
...
def test_add_labels_plugin_explicit(tmpdir, docker_tasker, auto_label, labels_docker,
