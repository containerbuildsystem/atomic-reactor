...
def test_allow_multiple_remote_sources(workflow, allow_multiple_remote_sources):
    ...
    first_remote_json_config_filename = 'remote-source-gomod.json.config'
    first_remote_json_env_filename = 'remote-source-gomod.json.env'
    ...
    second_remote_json_config_filename = 'remote-source-pip.json.config'
    second_remote_json_env_filename = 'remote-source-pip.json.env'
