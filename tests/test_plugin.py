...
@pytest.mark.parametrize('pluginconf_method, default_method, source_method, expected', [  # noqa
    ...
    ('orchestrator', 'docker_api',   'buildah',      'orchestrator'),
    (None,           'docker_api',   None,           'docker_api'),
    ([],             'docker_api',   'imagebuilder', 'imagebuilder'),
    ([],             'docker_api',   'buildah',      'buildah'),
    ...
    ([],             'imagebuilder', 'buildah',      'buildah'),
    ([],             'buildah',      None,           'buildah'),
    (None,           'buildah',      'buildah',      'buildah'),
    ([],             'buildah',      'docker_api',   'docker_api'),
    ([],             'buildah',      'imagebuilder', 'imagebuilder'),
])
