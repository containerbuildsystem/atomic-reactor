...
def get_maven_components(workflow):
    """
    Get list of maven components generated by post_generate_maven_metadata
    :param workflow: DockerBuildWorkflow instance
    :return: a list of maven components. Each component is a kojifile btype metadata dictionary
    :rtype: list[dict] # list of maven metadata dictionaries
    """
    plugin_results = workflow.postbuild_results.get(PLUGIN_GENERATE_MAVEN_METADATA_KEY) or {}
    return plugin_results.get('components', [])
