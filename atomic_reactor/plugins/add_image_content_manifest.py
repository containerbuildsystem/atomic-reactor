...
from atomic_reactor.utils.hermeto import convert_SBOM_to_ICM
...
class AddImageContentManifestPlugin(Plugin):
    ...
    def _get_hermeto_icm(self) -> dict:
    ...
    def _icm_base(self) -> dict:
        ...
        elif self.hermeto_remote_sources:  # we doesn't support Cachito and Hermeto together
            icm = self._get_hermeto_icm()
