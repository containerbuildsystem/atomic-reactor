...
class Cachi2PostprocessPlugin(Plugin):
    ...
    def postprocess_remote_sources(self) -> List[Cachi2RemoteSource]:
        ...
        for remote_source in self.init_plugin_data:
            ...
            sbom_path = os.path.join(remote_source['source_path'], 'deps', 'bom.json')
            ...
            remote_source_obj = Cachi2RemoteSource(
                ...
                json_data=generate_request_json(remote_source, sbom_data, json_env_data),
    ...
    def inject_into_build_dir(
        ...
        for remote_source in remote_sources:
            ...
            # TODO: reflink?
            copytree(remote_source['source_path']/'app', dest_dir/'app', symlinks=True)
            copytree(remote_source['source_path']/'deps', dest_dir/'deps', symlinks=True)
